...
COPY maxexectime.ini /etc/php/7.3/fpm/conf.d/maxexectime.ini
...
RUN cd /tmp; wget -c -t0 https://github.com/SSilence/selfoss/releases/download/2.18/selfoss-$SELFOSS_VERSION.zip -O selfoss-$SELFOSS_VERSION.zip
